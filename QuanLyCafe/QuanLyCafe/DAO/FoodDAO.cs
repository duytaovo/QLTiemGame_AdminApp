...
namespace QuanLyCafe.DAO
{
    public class FoodDAO
    {
        ...
        public static int FoodImageWidth = 170;
        public static int FoodImageHeight = 170;
        ...
        public bool InsertFood(string name, int id, float price, string link_image)
        {
            string query = string.Format("Insert Food (name, idCategory, price, link_image) Values (N'{0}', {1}, {2}, N'{3}')", name, id, price, link_image);
        ...
        public bool DeleteFood(int idFood)
        {
            ...
            int result = DataProvider.Instance.ExecuteNonQuery(query);
            fTableManager.links_image.RemoveAt(fTableManager.links_image.Count() - 1);
            return result > 0;
        }
