...
namespace QuanLyCafe.Logic_Layer
{
    class LogicHoaDon
    {
        ...
        public DataTable XemThongTinHoaDon(DateTime from_day, DateTime to_day, ref string err)
        {
            string sqlString = null;

            sqlString = "select * from XemThongTinHoaDon ('"+ from_day.ToString() +"','" + to_day.ToString()  + "')";
