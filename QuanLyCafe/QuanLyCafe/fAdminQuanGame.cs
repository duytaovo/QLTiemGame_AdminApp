...
namespace QuanLyCafe
{
    public partial class fAdminQuanGame : Form
    {
        ...
        void ClearThongTinDichVu()
        {
            ...
            txt_tenMon.Text = "";
            txt_giaDichVu.Text = "";
            txt_soLuongDichVu.Text = "";
            txt_trangThaiDichVu.Text = "";
        }
        void ClearThongTinUuDai()
        {
            txt_uuDaiId.Text = "";
            txt_uuDaiMaUuDai.Text = "";
            txt_uuDaiGiamGia.Text = "";
            txt_uuDaiIdDichVu.Text = "";
            txt_uuDaiIdNgayBatDau.Text = "";
            txt_uuDaiIdNgayKetThuc.Text = "";
            txt_uuDaiTrangThai.Text = "";
        }
        void ClearThongTinNhanVien()
        {
            txt_nvMa.Text = "";
            txt_nvHoten.Text = "";
            txt_nvGioitinh.Text = "";
            txt_nvNgaySinh.Text = "";
            txt_nvTenDangNhap.Text = "";
            txt_nvPassWord.Text = "";
            txt_nvNgayTao.Text = "";
            txt_nvSoDienThoai.Text = "";
            txt_nvDiachi.Text = "";
            txt_nvVaiTro.Text = "";
            txt_nvTrangThai.Text = "";
        }
        ...
        private void btn_clearThongTinMay_Click(object sender, EventArgs e)
        {
            ClearThonTinMay();
        }

        private void btn_XoaThongTinDichVu_Click(object sender, EventArgs e)
        {
            ClearThongTinDichVu();
        }

        private void btn_XoaThongTinUuDai_Click(object sender, EventArgs e)
        {
            ClearThongTinUuDai();
        }
        ...
        {
            this.Hide();
            string MaUuDai = dtgv_bill.Rows[e.RowIndex].Cells[0].Value.ToString();
            fChiTietHoaDon formChiTietHoaDon = new fChiTietHoaDon(MaUuDai);
        ...
        private void btn_ThongKe_Click(object sender, EventArgs e)
        {
            try
            {
                dtHoaDon = new DataTable();
                dtHoaDon.Clear();
                DataTable dataDisplay = dbHoaDon.XemThongTinHoaDon(dateTimePicker_FromDay.Value,
                                                                    dateTimePicker_ToDay.Value,
                                                                    ref err);
                dtHoaDon = dataDisplay;
                dtgv_bill.DataSource = dtHoaDon;
        ...
        private void btn_loadHoaDon_Click(object sender, EventArgs e) 
        {
            LoadHoaDon();
        }
    }
