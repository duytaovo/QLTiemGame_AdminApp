...
using Menu = QuanLyTiemGame.DTO.Menu;
...
namespace QuanLyTiemGame
{
    public partial class fTableManager : Form
    {
        ...
        public static List<string> links_image  = new List<string>();


        public Account LoginAccount { get => loginAccount; set => loginAccount = value;}
        public List<string> Links_image { get => links_image; set => links_image = value; }
        ...
        private void btn_addFood_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Không có đồ uống để thêm vào!!!", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            ...
            //PictureBox btn = new PictureBox() { Width = FoodDAO.FoodImageWidth, Height = FoodDAO.FoodImageHeight };
            //btn.Tag = item;

            Food food = cb_Food.SelectedItem as Food;
            Label lb = new Label();
            lb.Text = food.Name + Environment.NewLine + food.Price + "vnđ";
            txt_priceMonDangChon.Text = lb.Text;

            string link = food.Link_image;
            ptB_monDangChon.Image = Image.FromFile(link);
            ptB_monDangChon.SizeMode = PictureBoxSizeMode.Zoom;
        ...
        {
           /* Foods menuDoUong = new Foods();
            menuDoUong.Show();*/
        }

        private void cb_Food_Enter(object sender, EventArgs e)
        {
            if(cb_Food.SelectedValue != null)
            {
                Food food = cb_Food.SelectedItem as Food;
                Label lb = new Label();
                lb.Text = food.Name + Environment.NewLine + food.Price + "vnđ";
                ...
                string link = food.Link_image;
                ptB_monDangChon.Image = Image.FromFile(filename: link);
                ptB_monDangChon.SizeMode = PictureBoxSizeMode.Zoom;
            }
        }
        #endregion
